...
<div class="wpcsr_wrapper">
   <div class="ad_head_st"><h3><span class="dashicons dashicons-admin-generic"></span><?php echo ( esc_html__('Settings', 'wp-post-rating-pro'));?></h3>
  <div id="pro-notice"><?php echo ( esc_html__('Get ', 'wp-post-rating-pro'));?><span><a href="https://shorturl.at/lqtT7" target="_blank"><?php echo ( esc_html__('PRO', 'wp-post-rating-pro'));?></a></span><?php echo ( esc_html__(' version', 'wp-post-rating-pro'));?></div>
  </div>
  <div class="left-area">
  ...
  <div class="tab-content">
    <div id="home" class="tab tab-active" data-id="tab1">
      <div class="row-outer">
		  ...
		  <div class="col-2">
		  <?php $st_avglabel = isset($wpcr_options['rtlabel']) ? $wpcr_options['rtlabel'] : false;?>
		  <input type="text" name="wpcr_settings[rtlabel]" placeholder="Please rate" value="<?php echo esc_attr( $st_avglabel); ?>"  />
		  </div>
		  </div>
    ...
    <div id="menu1" class="tab " data-id="tab2">
		<div class="row-outer">
		 ...
		 <div class="row-outer">
		  ...
		  <input type="text" name="wpcr_settings[starsize]" placeholder="22" value="<?php echo isset($wpcr_options['starsize']) ? $wpcr_options['starsize'] : false; ?>" style="width: 50px;" /><span><?php echo ( esc_html__('px', 'wp-post-comment-rating'));?></span>
		  </div>
		  </div>
    ...
    <div id="menu2" class="tab " data-id="tab3">
      <div class="row-outer">
		  ...
		  <div class="col-2">
		  <?php $st_wpcravg_text[] = isset($wpcr_options['wpcravg_text']) ? $wpcr_options['wpcravg_text'] : false;?>
		  <input type="text" name="wpcr_settings[wpcravg_text]" placeholder="Average rating" value="<?php echo isset($wpcr_options['wpcravg_text']) ? $wpcr_options['wpcravg_text'] : false ?>" />
		  </div>
		  </div>
		  <div class="row-outer">
		  <div class="col-1">
		  ...
		  <input type="text" name="wpcr_settings[tiptxtsize]" placeholder="12" value="<?php echo isset($wpcr_options['tiptxtsize']) ? $wpcr_options['tiptxtsize'] : false; ?>" style="width: 50px;" /><span><?php echo ( esc_html__('px', 'wp-post-comment-rating'));?></span>
		  </div>
		  </div>
